...
class SchemaProjectionGenerator(object):
    ...
    def recurse_on_link_fields(self):
        ...
        filtered_pairs = [(name, rec)
                          for name, rec in name_recursion_pairs if rec]
    ...
    def noload_link_field_names(self):
        names = (
            self.basic_noload_link_field_names | self.renamed_attr_link_fields)
        return names
    ...
    def find_renamed_attr_fields(self):
        ...
        renamed_fields = [(field_type, name)
                          for field_type, name in result if name]
